...
# Article Guide — rumah.kayu.co.id
...
Source route evidence: sitemap XML, 287 routes discovered during packet generation
Reader community name: `Kayu.co.id`
...
- Address the reader warmly as `Sobat Kayu.co.id`, `Kawan Kayu.co.id`, or `Teman Kayu.co.id`. Use the exact opening salutation assigned inside the article file.
